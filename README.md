...
- **Courses & YouTube Hidden Gems** library: curated video companions mapped to each stage (Onur Mutlu's ETH lectures, Digi-Key's Intro to FPGA series, Vipin Kizheppatt's Vivado labs, Cornell ECE 5760, Robert Baruch's formal verification series, Verification Academy, and more) — plus a paid-training card (Doulos, Udemy tracks, Zero to ASIC, Maven Silicon, EDA vendor training) for when structure or certificates matter
